...
namespace ImGui
{
	...
	IMGUI_API bool          InputText(const char* label, char* str, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
